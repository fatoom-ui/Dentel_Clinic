...
namespace OnlineDentalClinic.Controllers
{
    ...
    public class TreatmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Treatment_Name,Treatment_Cost,Treatment_Description,Id")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("Treatment_Name,Treatment_Cost,Treatment_Description,Id")] Treatment treatment)
        {
            if (id != treatment.Id)
            {
                return NotFound();
